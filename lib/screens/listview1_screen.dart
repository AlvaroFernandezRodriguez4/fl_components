  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromRGBO(98, 96, 96, 1),
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            title: Text(casa),
            trailing: const Icon(Icons.arrow_forward_ios, color: Color.fromRGBO(131, 39,45, 1),),
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    ...
                    switch (casa) {
                      case 'Targaryen':
                        return const WidgetReutilizable(
                          ...
                          colorAppBar: Color.fromRGBO(212, 48, 49, 1),
                      ...
                      case 'Stark':
                        return const WidgetReutilizable(
                          ...
                          colorAppBar: Color.fromRGBO(133, 133, 133, 1),
                          colorBoton: Color.fromRGBO(133, 133, 133, 1),
                        );
                      case 'Lannister':
                        return const WidgetReutilizable(
                          titulo: 'Lannister',
                          ...
                          colorAppBar: Color.fromRGBO(233, 203,5, 1),
                          colorBoton: Color.fromRGBO(163, 5, 6, 1),
                      ...
                      case 'Baratheon':
                        return const WidgetReutilizable(
                          ...
                          colorAppBar: Color.fromRGBO(69, 69, 69, 1),
                          colorBoton: Color.fromRGBO(232, 203,5, 1),
                        );
                      default:
